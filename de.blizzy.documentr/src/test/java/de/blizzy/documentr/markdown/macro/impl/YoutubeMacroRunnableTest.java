...
import de.blizzy.documentr.markdown.macro.impl.YoutubeMacroRunnable;

public class YoutubeMacroRunnableTest extends AbstractDocumentrTest {
	private YoutubeMacroRunnable runnable;
	@Mock
	private IMacroContext context;

	@Before
	public void setUp() {
		runnable = new YoutubeMacroRunnable();
	}
